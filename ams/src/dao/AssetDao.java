...
public class AssetDao {
	...
	@SuppressWarnings("unchecked")
	public List searchByAid(String value, String typeid, String isdep,
			String isuse, String price1, String price2, String did, String uid) {
		...
		return this.search(hql, value, typeid, isdep, isuse, price1, price2,
				did, uid);
	}

	@SuppressWarnings("unchecked")
	public List searchByName(String value, String typeid, String isdep,
			String isuse, String price1, String price2, String did, String uid) {
	...
	@SuppressWarnings("unchecked")
	public List search(String hql, String value, String type,
			String deprecition, String usestate, String price1, String price2,
			String department, String user) {
		Session session = util.getSession();
		Query query = session.createQuery(hql);
		String str;
