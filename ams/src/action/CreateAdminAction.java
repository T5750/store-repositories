...
public class CreateAdminAction {
	...
	public String create() throws IOException {
		...
		Admin adm = (Admin) ServletActionContext.getRequest().getSession()
				.getAttribute("admin");
		if (adm.getPermission() != 0) {
			return null;
		}
		if (admin.getUsername().equals("") || admin.getName().equals("")
				|| admin.getEmail().equals("") || did.equals("0")
				|| confirm.equals("") || admin.getPassword().equals("")) {
			out.print("empty");
			return null;
		}
		...
		if (isIE == 1) {
			...
			username = new String(admin.getUsername().getBytes("ISO-8859-1"),
					"gbk");
		} else {
