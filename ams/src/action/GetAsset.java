...
public class GetAsset {
	...
	public String get() throws IOException {
		...
		if (asset.getManufacturedate() != null)
			str += "</li><li>出厂日期: "
					+ asset.getManufacturedate().toString().substring(0, 10);
		else
			str += "</li><li>出厂日期: 暂无信息";
		str += "</li><li>购买时间: "
				+ asset.getBuydate().toString().substring(0, 10);
		...
		if (asset.getUsestate() == 3)
			str += "</ul><ul></li><li>使用情况: 送修 <span class='sxwb' relid='"
					+ asset.getId() + "'>点此送修完毕</span>";
