...
public class TestDate {
	public static void main(String[] args) throws ParseException {
		...
		// Query query =
		// hu.getQuery("from Test t where TO_DAYS(NOW()) - TO_DAYS(t.testdate)>=30");
		...
		// String hql =
		// "from Assets a where a.assetname like ? and a.type = ? ";
		...
		// String hql =
		// "from Bsend a where TO_DAYS(NOW()) - TO_DAYS(a.bsenddate)<=30";
